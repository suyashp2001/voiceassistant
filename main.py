...
def pizza():
    driver = webdriver.Chrome(r"C:\Users\suyash\Desktop\chromedriver.exe");
    ...
    driver.find_element_by_xpath(
        '//*[@id="__next"]/div/div/div[1]/div[1]/div/div[2]/div/div[3]/div/div[1]/div[2]/div/div[2]/button/span'
    ...
    if "yes" in query_fav:
        try:
            driver.find_element_by_xpath(
                '//*[@id="mn-lft"]/div[12]/div/div[1]/div/div/div[2]/div[3]/div/button/span'
            ).click()
            sleep(1)
        except:
            ...
            try:
                ...
                if qty_pizza > 0:
                    ...
                    for i in range(qty_pizza):
                        driver.find_element_by_xpath(
                            '/html/body/div[2]/div/div/div[1]/div[2]/div[2]/div[2]/div[2]/div/div/div[1]/div/div/div/div[2]/div/div/div[2]'
                        ).click()
            except:
        ...
        if "yes" in check_order:
            ...
            total = driver.find_element_by_xpath(
                '//*[@id="__next"]/div/div/div[1]/div[2]/div[2]/div[2]/div[2]/div/div/div[2]/div[1]/span[2]'
            )
        ...
        talk("Placing order")
        driver.find_element_by_xpath(
            '//*[@id="__next"]/div/div[1]/div[2]/div[3]/div[2]/div/div[6]/div/div/div[7]/button'
        ).click()
        sleep(2)
        try:
        ...
        if "yes" in confirm:
            ...
            driver.find_element_by_xpath(
                '//*[@id="__next"]/div/div[1]/div[2]/div/div[1]/div[2]/div/div[2]/div/div[2]/button/span'
            ).click()
            sleep(2)
    ...
    try:
        ...
        if call(text):
            ...
            if "date" in text or "day" in text or "month" in text:
                ...
                speak = speak + "You are Suyash Santosh Patankar. the one who has created me"
                ...
                if js["cod"] != "404":
                    ...
                    weather_response = "In " + str(location) + " the temperature  in Celcius is " + str(round(temperature)) + " the humidity " + str(humidity) + " and the weather description  is " + str(desc)
